...
public class Default {
	...
	public static int[] scV = { 0, 1, 5, 10, 25, 50, 75, 100, 200, 300, 400, 500, 750, 1000, 5000, 10000, 25000, 50000,
	...
	public void gameDefault() {
		while (run) {
			...
			System.out.println("\nROUND " + round);
			for (int i = 0; i < 6; i++) {
				m.eliminateSC(scI, scV);
			}
			m.draw(scI);
			// m.drawValues(scV);
			if (m.bankOffer(scI, scV, pV, round) > 0) {
				break;
			}
			round++;
